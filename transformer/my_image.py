...
class RandomTransform(DualTransform):
    ...
    def apply(
        ...
        **params,
        ...
        return ndimage.perspective_transform(
            image,
            self.width,
            self.height,
            m,
    ...
    def apply(self, image, bboxes=None, **params):
        ...
        if self.object_aware:
            ...
            def is_intersection(bboxes_a, bboxes_b):
                ...
                https://github.com/ak110/pytoolkit/blob/master/pytoolkit/od.py
                """
