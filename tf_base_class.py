...
Usage:
    ...
    $ python tf_base_class.py -m tuning -n_t 1 -t_out_dir D:\work\kaggle_data\Cats_VS._Dogs\results\tmp
"""
import os
import sys
import time
...
class Objective(object):
    ...
    def get_class_fine_tuning_parameter_suggestions(self, trial) -> dict:
        ...
        my_IDG_options = {
            ...
            "random_erasing_prob": trial.suggest_categorical(
        ...
        return {
            ...
            "choice_model": trial.suggest_categorical(
                "choice_model",
                ["VGG16", "Xception", "InceptionV3", "DenseNet121", "EfficientNet"],
            ),
            ...
            "is_skip_bn": False,
            "trainable": trial.suggest_categorical(
                "trainable", ["all", 100, 200, 300, 400, 500, 600]
            ),
            "efficientnet_num": trial.suggest_categorical(
                "efficientnet_num", [3, 4, 5, 6, 7]
            ),
            # full layer param
            ...
            "is_add_batchnorm": trial.suggest_categorical(
        ...
        try:
            ...
            if check_err < self.trial_best_err:
                ...
                if (
                    ...
                    shutil.copyfile(
                        os.path.join(args["output_dir"], "best_val_accuracy.h5"),
                        os.path.join(args["output_dir"], "best_trial_acc.h5"),
                    )
