...
10行単位でデータフレーム表示して、指定列の棒グラフをplotするアプリ
...
BAR_COL_LIST = ['pop', 'lifeExp', 'gdpPercap'] # 棒グラフ出す列名
df = pd.read_csv('https://raw.githubusercontent.com/plotly/datasets/master/gapminder2007.csv') # ロードするcsv
##########################################################################
...
def update_graphs(row_ids, selected_row_ids, active_cell):
    ...
    return [
        ...
        for column in BAR_COL_LIST if column in dff
    ]
