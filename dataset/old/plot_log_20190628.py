...
def overlaid_plot_results(out_dir, hist_file_list):
    ...
    plt.ylabel('acc')
    plt.ylim((0, 1))
    plt.savefig(os.path.join(out_dir, 'train_acc.png'), bbox_inches="tight")# label見切れ対策 bbox_inches="tight"
    plt.show()
    ...
    plt.ylabel('acc')
    plt.ylim((0, 1))
    plt.savefig(os.path.join(out_dir, 'validation_acc.png'), bbox_inches="tight")# label見切れ対策 bbox_inches="tight"
    plt.show()
